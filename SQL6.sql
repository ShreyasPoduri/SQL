...
SELECT NAME, SALARY FROM DEPARTMENT WHERE SALARY > 10000;

SELECT MAX(SALARY) AS "Highest Salary" FROM DEPARTMENT;

SELECT MIN(SALARY) AS "Lowest Salary" FROM DEPARTMENT;
